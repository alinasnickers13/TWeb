...
import { store_mock_data } from '../data_array/store_mock_data';


var data_log : any;

export const My_form_login= () => {
        ...
        try{
            Array.from(JSON.parse(data_log)).map((el:any) => {
                ...
                if ( email==el.email && password==el.password ){
                    ...
                    setTimeout(function() {
                        notification.open({
                            message: 'Login utilizator '+el.first_name+" "+el.last_name,
                        })
                     }, 2000);
